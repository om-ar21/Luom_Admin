...
<div class="toolbar min-h-70px" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<c:if test="${c!=2 }">
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Détails annulation</h1></c:if>
									<c:if test="${c==2 }">
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Problèmes commandes</h1></c:if>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<li class="breadcrumb-item text-muted"><c:if test="${c!=2 }"><a href="Cmdsupp" class="text-muted text-hover-primary">Commandes annulées</a></c:if><c:if test="${c==2 }"><a href="Cmdpb" class="text-muted text-hover-primary">Problèmes commandes</a></c:if></li>
										...
										<div class="card card-xl-stretch mb-5 mb-xl-8">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bolder fs-3 mb-1">Détails annulation</span>
													
												</h3>
												<div class="d-flex justify-content-end ">
											<!--begin::Button-->
											<c:if test="${c!=2 }">
											<a href="Cmdsupp" id="kt_ecommerce_add_product_cancel" class="btn btn-light m-5  ">Retour</a>
											</c:if>
											<c:if test="${c==2 }">
											<a href="Cmdpb" id="kt_ecommerce_add_product_cancel" class="btn btn-light m-5  ">Retour</a>
											</c:if>
											<!--end::Button-->
											<!--begin::Button-->
