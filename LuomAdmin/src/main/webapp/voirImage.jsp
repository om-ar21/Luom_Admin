...
<div class="toolbar min-h-70px" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Ref img ${image.id}</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<li class="breadcrumb-item text-muted"><a href="AddImage?id=${prd.id }" class="text-muted text-hover-primary">Images</a></li>
										
										<li class="breadcrumb-item">
											<span class="bullet bg-gray-300 w-5px h-2px"></span>
										</li>
										
										<li class="breadcrumb-item text-dark">Ref img ${image.id}</li>
									...
									<div class="w-100 flex-lg-row-auto w-lg-300px mb-7 me-7 me-lg-10">
										...
										<div class="card card-flush py-4">
											...
											<div class="card-body pt-0">
												...
												<select name="id_prods" id="id_prods" parsley-trigger="change" required  class="form-select mb-2" disabled>
										...
										<div class="card card-flush py-4">
														...
														<div class="card-body pt-0">
															...
															<div class="fv-row mb-2">
																...
																<p type="text" name="img" class="form-control mb-2">${image.lien}</p>
