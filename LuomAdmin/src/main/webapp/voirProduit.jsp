							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<li class="breadcrumb-item text-mutedtext-dark">Fiche</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
													...
													<div class="card card-flush py-4">
														...
														<div class="card-body pt-0">
															...
															<div class="mb-10 fv-row">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<p class="form-control mb-2">${cproduit.titre}</p>
																<!--end::Input-->
																<!--begin::Description-->
															...
															<div class="mb-10 fv-row">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<p class="form-control mb-2">${cproduit.prix}</p>
																<!--end::Input-->
																<!--begin::Description-->
																<!--end::Description-->
															</div>
															...
															<div>
																...
																<p class="form-control min-h-200px mb-2" >${cproduit.presentation}</p>
																<!--end::Label-->
																<!--begin::Editor-->
															...
															<div class="mt-10 fv-row">
																<!--begin::Label-->
																<label class="required form-label">Quantités</label>
																<!--end::Label-->
																<!--begin::Input-->
																<div class="d-flex gap-3">
																	<p class="form-control mb-2">${cproduit.stock }</p>
																	<p class="form-control mb-2">${cproduit.stock_minimum }</p>
																	<p class="form-control mb-2">${qcom}</p>
																</div>
																<!--end::Input-->
																<!--begin::Description-->
																<div class="text-muted fs-7"> Quantités en stock / Quantité Critique / Quantité commandée </div>
																<!--end::Description-->
															</div>
													...
													<div class="card card-flush py-4 mb-10">
														...
														<div class="card-body pt-0">
															...
															<div class="fv-row mb-2">
																...
																<p class="form-control mb-2">${cproduit.img}</p>
																<!--end::Dropzone-->
															</div>
															<!--end::Input group-->
															<!--begin::Description-->
															<div class="text-muted fs-7">Image Principale.</div>
															<!--end::Description-->
														</div>
														<!--end::Card header-->
													</div>
													...
													<div class="card card-flush py-4">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<div class="menu-item px-3">
																<a href="VoirProduit?id=${cproduit.id }&idtohide=${ c.id }" class="menu-link px-3" data-kt-ecommerce-product-filter="hidden_row">Cacher</a>
															</div>
															</c:if>
															
															<c:if test="${c.del==true}">
															<div class="menu-item px-3">
																<a href="VoirProduit?id=${cproduit.id }&idtounhide=${ c.id }" class="menu-link px-3" data-kt-ecommerce-product-filter="hidden_row">Rétablir</a>
															</div>
															</c:if>
															
															<div class="menu-item px-3">
																<a href="VoirProduit?id=${cproduit.id }&idtodelcom=${ c.id }" class="menu-link px-3" >Supprimer</a>
															</div>
