...
<div class="toolbar min-h-70px" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Modifier ${scat.titre }</h1>
									<!--end::Title-->
									<!--begin::Separator-->
...
<form method="post">
										...
										<div class="card card-flush py-4">
											...
											<div class="card-body pt-0">
												...
												<div class="mb-10 fv-row">
													...
													<!--end::Label-->
													<!--begin::Input-->
													<input type="text" name="titre" class="form-control mb-2" placeholder="Nom de la catégorie" value="${scat.titre }" />
													<!--end::Input-->
													<!--begin::Description-->
													
													<!--end::Description-->
													<%Souscategorie s = (Souscategorie)request.getAttribute("scat");
              										if(s.getId()!=13){ %>
										...
										<div class="d-flex justify-content-end mb-5 mt-5">
											...
											<!--end::Button-->
											<!--begin::Button-->
											<button name="btncat" value="${idamodif}" id="kt_ecommerce_add_category_submit" class="btn btn-primary">
												Sauvegarder
