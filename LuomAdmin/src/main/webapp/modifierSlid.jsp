...
<div class="toolbar min-h-70px" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">${sl.titre}</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted"><a href="Slid" class="text-muted text-hover-primary">Sliders</a></li>
								...
								<form id="kt_ecommerce_edit_order_form" class="form d-flex flex-column flex-lg-row"  method="POST">
									...
									<div class="w-100 flex-lg-row-auto w-lg-300px mb-7 me-7 me-lg-10">
										...
										<div class="card card-flush py-4 mb-5">
											...
											<div class="card-body text-center pt-0">
												...
												<div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="">
													...
													<div class="image-input-wrapper w-150px h-150px" style="background-image: url(${sl.img})"></div>
											...
											<div class="d-flex justify-content-center mb-7">
														<!--begin::Action menu-->
														<a href="ModifierSlid?id=${sl.id }&idtodel=${sl.id }" class="btn btn-danger ps-7">Supprimer
										...
										<div class="card card-flush py-4">
											...
											<div class="card-body pt-0">
												...
												<!--end::Select2-->
												<!--begin::Description-->
												<div class="text-muted fs-7">Definir le status.</div>
												<!--end::Description-->
												<!--begin::Datepicker-->
									...
									<div class="d-flex flex-column flex-lg-row-fluid gap-7 gap-lg-10">
												...
												<c:if test="${messageok==true }">
														...
														<div class="card-body pt-0">
															...
															<div class="fv-row mb-2">
																...
																<input type="text" name="titre" class="form-control mb-2" placeholder="${sl.titre}" value="${sl.titre}" />
																<label class="form-label">Lien</label>
																<input type="text" name="img" class="form-control mb-2" placeholder="${sl.img}" value="${sl.img}" />
																<label class="form-label">Lien</label>
																<input type="text" name="lien" class="form-control mb-2" placeholder="${sl.lien}" value="${sl.lien}"/>
										...
										<div class="d-flex justify-content-end">
											<!--begin::Button-->
											<a href="Slid" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5 mb-10">Retour</a>
											<!--end::Button-->
											<!--begin::Button-->
