...
<div class="toolbar min-h-70px" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Modifier Fournisseur</h1>
									<!--end::Title-->
									<!--begin::Separator-->
...
<form method="post">
										...
										<div class="card card-flush py-4">
											...
											<div class="card-body pt-0">
												...
												<div class="mb-10 fv-row">
													...
													<!--end::Label-->
													<!--begin::Input-->
													<input type="text" name="titre" class="form-control mb-2" placeholder="Nom du Fournisseur" value="${fou.nom}" />
													<!--end::Input-->
													<!--begin::Description-->
										...
										<div class="d-flex justify-content-end mb-5 mt-5">
											<!--begin::Button-->
											<a href="Four" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Retour</a>
											<!--end::Button-->
											<!--begin::Button-->
											<button name="btnmod" value="${fou.id}" id="kt_ecommerce_add_category_submit" class="btn btn-primary">
												Sauvegarder
