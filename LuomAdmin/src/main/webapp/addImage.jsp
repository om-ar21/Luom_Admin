								...
								<form id="kt_ecommerce_edit_order_form" class="form d-flex flex-column flex-lg-row"  method="POST">
									...
									<div class="d-flex flex-column flex-lg-row-fluid gap-7 gap-lg-10">
										...
										<div class="card card-flush py-4">
														...
														<div class="card-header">
															<div class="card-title">
																<h2>Image à ajouter</h2>
															</div>
															<div>
															<c:if test="${messageok==true }">
															<div class="alert alert-success mt-2">Ajout réalisé</div>
															</c:if>
										...
										<div class="card card-flush py-4 mb-10">
											...
											<div class="card-header">
												...
												<c:if test="${interdit==true }">
															<div class="alert alert-danger mt-2">Opération interdite</div>
											...
											<div class="card-body pt-0">
												<div class="d-flex flex-column gap-10">
													...
													<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_edit_order_product_table">
														...
														<thead>
															<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
																<th>Image</th>
																<th class="min-w-27px text-end pe-5">Visibilité</th>
													...
													<td class="text-end pe-0" data-order="Ma">
														<!--begin::Badges-->
														<div class="badge badge-light-danger">Masquée</div>
														<!--end::Badges-->
													</td>
													</c:if>
													...
													<td class="text-end pe-0" data-order="Visi">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<c:if test="${i.del==true}">
															<div class="menu-item px-3">
																<a href="AddImage?id=${ i.id }&idtounhide=${ i.id }" class="menu-link px-3" data-kt-ecommerce-product-filter="hidden_row">Rétablir</a>
															</div>
															</c:if>
