...
<div class="toolbar min-h-70px" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Archivés</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">Archivés</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
											...
											<div class="card-header align-items-center py-5 gap-2 gap-md-5">
												...
												<div>
													<%-- <c:if test="${messageok==true }">
															<div class="alert alert-success btn-sm">Opération réussie</div>
															</c:if> --%>
															<c:if test="${interdit==true }">
															<div class="alert alert-danger btn-sm">Opération interdite</div>
															</c:if><!-- url test = Archive?idtodel=7 -->
												...
												<table class="table table-hover table-row-dashed fs-6 gy-5 my-0" id="kt_inbox_listing">
													...
													<c:forEach var="c" items="${requestScope['cts']}" >
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<div class="menu-item px-3">
																<a href="Archive?idunarch=${ c.id }" class="menu-link px-3">Rétablir</a>
															</div>
															<!--end::Menu item-->
															<!--begin::Menu item-->
															...
															<div class="menu-item px-3">
																<a href="Archive?idtohide=${ c.id }" class="menu-link px-3" data-kt-ecommerce-product-filter="hidden_row">Marquer Vu</a>
															</div>
															</c:if>
															
															<c:if test="${c.etat==true}">
															<div class="menu-item px-3">
																<a href="Archive?idtounhide=${ c.id }" class="menu-link px-3" data-kt-ecommerce-product-filter="hidden_row">Noter non Vu</a>
															</div>
															</c:if>
															
															<c:if test="${sessionScope.droit==1}">
															<div class="menu-item px-3">
																<a href="Archive?idtodel=${ c.id }" class="menu-link px-3">Supprimer</a>
															</div></c:if>
