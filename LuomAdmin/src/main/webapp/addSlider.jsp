...
<div class="toolbar min-h-70px" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Ajouter Slider</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<div class="w-100 flex-lg-row-auto w-lg-300px mb-7 me-7 me-lg-10">
										...
										<div class="card card-flush py-4">
											...
											<div class="card-body pt-0">
												...
												<!--end::Select2-->
												<!--begin::Description-->
												<div class="text-muted fs-7 mb-5">Définir le status.</div>
												<!--end::Description-->
												<!--begin::Datepicker-->
										...
										<div class="card card-flush py-4">
														...
														<div class="card-body pt-0">
															...
															<div class="fv-row mb-2">
																...
																<input type="text" name="titre" class="form-control mb-2" placeholder="Titre du slider"/>
																<label class="required form-label">image</label>
																<input type="text" name="img" class="form-control mb-2" placeholder="Lien Image slider"/>
																<label class="required form-label">Lien</label>
																<input type="text" name="lien" class="form-control mb-2" placeholder="Lien Redirection slider"/>
																<!--end::Dropzone-->
															</div>
															<!--end::Input group-->
															<!--begin::Description-->
