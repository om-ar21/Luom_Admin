...
/**
 * Servlet implementation class Cmdsupp
 */
public class Cmdsupp extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Commande> cmdsup = cmd.getAllDel();
		
		request.setAttribute("cmdsup", cmdsup);
		
		if(!load) {
		request.getRequestDispatcher("cmdsuppr.jsp").forward(request, response);
			}}}
	}
